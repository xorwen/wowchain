...
def validate_engaging_token():
    ...
    if partner_id:
        ...
        async_broadcast(partner_id, f"Excellent! You are now connected with {user_name}")
        async_broadcast(user_id, f"Excellent! You are now connected with {get_my_partner_name(user_id)}")
